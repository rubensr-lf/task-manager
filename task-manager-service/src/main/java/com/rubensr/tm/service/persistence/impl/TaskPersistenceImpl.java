...
package com.rubensr.tm.service.persistence.impl;
...
import com.rubensr.tm.model.impl.TaskImpl;
import com.rubensr.tm.model.impl.TaskModelImpl;
import com.rubensr.tm.service.persistence.TaskPersistence;
import com.rubensr.tm.service.persistence.impl.constants.TMPersistenceConstants;
...
public class TaskPersistenceImpl
	...
	public Task[] findByC_U_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_U_PrevAndNext(
				session, task, companyId, userId, orderByComparator, true);

			array[1] = task;

			array[2] = getByC_U_PrevAndNext(
				session, task, companyId, userId, orderByComparator, false);
	...
	protected Task getByC_U_PrevAndNext(
		Session session, Task task, long companyId, long userId,
		OrderByComparator<Task> orderByComparator, boolean previous) {
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			TaskModelImpl.CREATEDATE_COLUMN_BITMASK |
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.rubensr.tm.model.Task"),
			true);
	}
